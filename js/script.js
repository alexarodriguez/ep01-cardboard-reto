window.onload = function()
{
 ...
 for (var i = 0; i < planetas.length; i++) {
        ...
        */
        ...
        ///hago lo mismo como elcubo pero para el array planetas
    ...
    var puntoDeVista = function()
	{
        ...
        for (var i = 0; i < planetas.length; i++) {
            if(punto < planetas.length){
                punto++;
            }else{
                punto=0;
            }
            if(frustum.intersectsObject(planetas[i].objeto) && frustum.intersectsObject(planetas[punto].objeto)){
                        if(!planetas[i].vista){
                            planetas[i].vista = true;
                            responsiveVoice.speak("Estas viendo el planeta "+planetas[i].nombre +" y "+planetas[i+1].nombre, "Spanish Female");
                        }
                    }else{
